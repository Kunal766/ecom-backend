...
let transporter = nodemailer.createTransport({
  ...
  auth: {
    user: 'kunalnayak766@gmail.com', // gmail
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          <tr>
            <td align="center" valign="top" style="padding: 36px 24px;">
              <a href="https://kunal766.github.io" target="_blank" style="display: inline-block;">
                <img src="./assets/icons/icons8-html-5.svg" alt="Logo" border="0" width="48" style="display: block; width: 48px; max-width: 48px; min-width: 48px;">
              </a>
            </td>
          </tr>
        </table>
